          ...
          <div className="mb-6 flex justify-center">
            ...
            >
              <Fut7StatsLogo
                width={120}
                height={120}
                className="drop-shadow-[0_0_30px_rgba(59,130,246,0.4)]"
              />
            </Link>
          </div>

          <CardTitle className="text-4xl font-bebas tracking-widest text-white">
            ACCESO MIEMBROS
          </CardTitle>
        ...
        <CardContent className="pb-10">
          ...
          <div className="mt-8 flex flex-col gap-4 text-center">
            <Button
              variant="link"
              asChild
              className="text-muted-foreground hover:text-primary text-[10px] font-oswald uppercase tracking-widest"
            >
              <Link
                href="/"
